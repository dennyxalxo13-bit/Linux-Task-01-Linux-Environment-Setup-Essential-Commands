...
1. **What is Linux?** — An open-source operating system based on Unix that manages hardware and software resources, accessible via GUI or command-line.
2. **Why is Linux important in cybersecurity?** — It offers strong security, stability, flexibility, and powerful CLI tools; most security tools and servers run on Linux.
3. **Linux vs. Windows** — A comparison of openness, cost, security, customizability, and primary user base.
...
---
*This repository is part of an ongoing internship task series focused on building practical Linux and cybersecurity fundamentals.*
